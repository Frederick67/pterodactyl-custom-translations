    ...
    var eldomain = document.getElementById("subdomain");
    ...
    if(typeof(eldomain) != 'undefined' && eldomain != null){
        
        document.getElementById("sbDomain").style.display = "";

    } 
    else{

        document.getElementById("sbDomain").style.display = "none";
    }
...
function myFunction() {
  ...
  function openDomain() {
    var button = document.getElementById("subdomain");
    button.click('subdomain')
}
