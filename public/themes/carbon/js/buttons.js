...
function myFunction() {
  ...
  function openSubdomain() {
        var url = window.location.pathname.replace("/files","").replace("/databases","").replace("/schedules","").replace("/users","").replace("/backups","").replace("/subdomain","").replace("/versions","").replace("/plugins","").replace("/network","").replace("/startup","").replace("/settings","");
        window.location = url + "/subdomain";
  }
  function openVersion() {
    var url = window.location.pathname.replace("/files","").replace("/databases","").replace("/schedules","").replace("/users","").replace("/backups","").replace("/subdomain","").replace("/versions","").replace("/plugins","").replace("/network","").replace("/startup","").replace("/settings","");;
    window.location = url + "/versions";
}
function openPlugin() {
    var url = window.location.pathname.replace("/files","").replace("/databases","").replace("/schedules","").replace("/users","").replace("/backups","").replace("/subdomain","").replace("/versions","").replace("/plugins","").replace("/network","").replace("/startup","").replace("/settings","");;
    window.location = url + "/plugins";
}
