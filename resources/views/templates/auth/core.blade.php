@inject('BLang', 'Pterodactyl\Models\Billing\BLang')
    ...
    <div id="{{ config('carbonlang.author', 'n/a') }} {{ config('carbonlang.version', 'unset') }}" class="menu">
        ...
        <div class="btn"><a href="https://discord.gg/tCr6kzYgbb" target="_blank" style="color:white;">{{ config('carbonlang.button_name', 'Discord') }}</a></div>
		<div class="btn"><a href="https://lunarnodes.eu/UserAgreement.html" target="_blank" style="color:white;">TOS</a></div>
      </div>
    </header>
    <!-- MAIN CONTENT -->
